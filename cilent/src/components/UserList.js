...
// import axios from 'axios';
// import UserCard from './UserCard';  // Ensure UserCard is imported
// import { Container, Pagination, Form, Button, Alert } from 'react-bootstrap';
...
//     domain: '',
//     available: false,
//     avatar: '' // Optional, adjust based on your user schema
//   });
...
//         return;
//       }
//       console.log('Creating user with data:', newUser); // Debugging line
//       const response = await axios.post('http://localhost:5100/users', newUser);
//       console.log('User created:', response.data); // Debugging line
